...
// Validate ../../app/api/logs/driver/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/logs/driver">> = Specific
  const handler = {} as typeof import("../../app/api/logs/driver/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/logs/latest/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/logs/latest">> = Specific
  const handler = {} as typeof import("../../app/api/logs/latest/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
