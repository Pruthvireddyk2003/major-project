...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},21628,a=>{"use strict";var b=a.i(87924),c=a.i(50944),d=a.i(72131),e=a.i(6704);function f(){let a=(0,c.useRouter)(),f=(0,c.usePathname)(),[g,h]=(0,d.useState)(!1);return((0,d.useEffect)(()=>{h(!!localStorage.getItem("token"))},[f]),"/login"===f)?null:(0,b.jsx)("nav",{className:"w-full bg-white shadow-md sticky top-0 z-50",children:(0,b.jsxs)("div",{className:"flex justify-between items-center w-full px-8 py-4",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-blue-600 cursor-pointer",onClick:()=>a.push("/"),children:"Driver Monitoring"}),g&&(0,b.jsxs)("div",{className:"flex items-center space-x-6",children:[(0,b.jsx)("button",{onClick:()=>a.push("/"),className:`text-gray-700 hover:text-blue-600 ${"/"===f?"font-semibold":""}`,children:"Dashboard"}),(0,b.jsx)("button",{onClick:()=>a.push("/live"),className:`text-gray-700 hover:text-blue-600 ${"/live"===f?"font-semibold":""}`,children:"Live"}),(0,b.jsx)("button",{onClick:()=>{localStorage.removeItem("token"),localStorage.removeItem("driverId"),e.default.success("Logged out"),a.push("/login")},className:"bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition",children:"Logout"})]})]})})}a.s(["default",()=>f])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__464035eb._.js.map